...
describe 'standard42' do
  ...
  describe 'Test standard installation with monitoring and firewalling' do
    ...
    it 'should monitor the process' do
      content = catalogue.resource('monitor::process', 'standard42_process').send(:parameters)[:enable]
      content.should == true
    end
  ...
  describe 'Test customizations - source' do
    let(:params) { {:source => "puppet://modules/standard42/spec" , :source_dir => "puppet://modules/standard42/dir/spec" , :source_dir_purge => true } }

    it 'should request a valid source ' do
      content = catalogue.resource('file', 'standard42.conf').send(:parameters)[:source]
      content.should == "puppet://modules/standard42/spec"
    end
    it 'should request a valid source dir' do
      content = catalogue.resource('file', 'standard42.dir').send(:parameters)[:source]
      content.should == "puppet://modules/standard42/dir/spec"
    end
    it 'should purge source dir if source_dir_purge is true' do
      content = catalogue.resource('file', 'standard42.dir').send(:parameters)[:purge]
      content.should == true
    end
  end
  ...
  describe 'Test Puppi Integration' do
    ...
    it 'should generate a puppi::ze define' do
      content = catalogue.resource('puppi::ze', 'standard42').send(:parameters)[:helper]
  ...
  describe 'Test Monitoring Tools Integration' do
    ...
    it 'should generate monitor defines' do
      content = catalogue.resource('monitor::process', 'standard42_process').send(:parameters)[:tool]
